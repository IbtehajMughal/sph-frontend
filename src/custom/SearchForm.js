...
export default function SearchForm() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    console.log(data);
    axios
      .post("http://localhost:3000/v1/scrap", {
      ...
      .then((res) => {
        toast.current.show({
          severity: "success",
          summary: "Successfull ",
          detail: "Scraping has been started.",
        });
        // reset()
      })
      .catch((err) => {
          ...
          <form onSubmit={onSubmit}>
            <div className="p-fluid formgrid grid">
              ...
              <div className="field col-12 md:col-6">
                ...
                <InputText
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Name of the City you want to search in"
                  id="city"
                  type="text"
                  {...register("city")}
                />
              ...
              <div className="field col-12 md:col-6">
                ...
                <InputText
                  id="state"
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Name of the state you want search in"
                  type="text"
                  {...register("state")}
                />
              </div>
              <div className="field col-12 md:col-6">
                ...
                <InputText
                  id="radius"
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Area around you, you want to search in KM"
                  type="text"
                  {...register("radius")}
                />
              </div>
              ...
              <div className="field col-12 md:col-6">
                ...
                <Dropdown
                  ...
                  value={
                    CONDITIONS.filter(
                      (c) => c.code === getValues("condition")
                    )[0]
                  }
                  onChange={(e) => setValue("condition", e.value.code)}
                  options={CONDITIONS}
                  optionLabel="name"
              ...
              <div className="field col-12 md:col-6">
                ...
                <Dropdown
                  id="platform"
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Platform for sraping"
                  value={
                    PLATFORMS.filter((c) => c.code === getValues("platform"))[0]
                  }
                  onChange={(e) => setValue("platform", e.value.code)}
                  options={PLATFORMS}
                  optionLabel="name"
                  placeholder="Select One"
                ></Dropdown>
              ...
              <div className="field col-12 md:col-6">
                ...
                <InputText
                  id="MinPrice"
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Minimun price of the product"
                  type="number"
                  {...register("minPrice")}
                />
              </div>
              <div className="field col-12 md:col-6">
                ...
                <InputText
                  id="MaxPrice"
                  tooltipOptions={{ position: "bottom" }}
                  tooltip="Maximum price of the product"
                  type="number"
                  {...register("maxPrice")}
                />
              </div>
